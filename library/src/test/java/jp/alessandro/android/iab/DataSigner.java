...
public class DataSigner {
     ...
     * @return
     */
    public static String sign(String signedData) {
        ...
        try {
            ...
            KeyFactory kf = KeyFactory.getInstance(Security.KEY_FACTORY_ALGORITHM);
            PrivateKey privateKey = kf.generatePrivate(spec);

            Signature sig = Signature.getInstance(Security.SIGNATURE_ALGORITHM);
